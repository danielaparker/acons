...
struct row_major
{
    template <class T, size_t N, class Order, class Base, class TPtr> using iterator = row_major_iterator_base<T,N,Order,Base,TPtr>;
...
struct column_major
{
    template <class T, size_t N, class Order, class Base, class TPtr> using iterator = column_major_iterator_base<T,N,Order,Base,TPtr>;
